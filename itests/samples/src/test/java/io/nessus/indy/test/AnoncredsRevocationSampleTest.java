...
import static org.hyperledger.indy.sdk.anoncreds.Anoncreds.generateNonce;
...
import io.nessus.indy.utils.EnvironmentUtils;
import io.nessus.indy.utils.PoolUtils;


public class AnoncredsRevocationSampleTest {
	...
	public void testLedger() throws Exception {
		...
		logInfo("Anoncreds Revocation sample -> started");
		...
		logInfo("Anoncreds Revocation sample -> completed");
	}
